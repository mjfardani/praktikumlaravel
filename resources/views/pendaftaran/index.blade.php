        ...
        <div class="row">
            ...
            <div class="col-auto">
                <select name="status" id="status" class="form-select">
                    ...
                    <option @selected($status == 'DAFTAR') value="DAFTAR">DAFTAR</option>
                    <option @selected($status == 'TERIMA') value="TERIMA">DITERIMA</option>
                    <option @selected($status == 'TOLAK') value="TOLAK">TIDAK DITERIMA</option>
                </select>
            </div>
            <div class="col-auto">
        ...
        <tbody>
            @forelse ($pendaftarans as $pendaftaran)
                        <tr>
                            ...
                            <td>{{ $pendaftaran->prodi->fakultas->nama_fakultas
                    . '-' . $pendaftaran->prodi->nama_prodi }}<br />
                                Pada
                                {{ \Carbon\Carbon::parse(
